                ...
                {notifItems.map(({ kind }) =>
                  kind === "cover_needed" ? (
                    ...
                    >
                      ...
                      <p className="text-xs">
                        {rotaLifecycleUnread} rota edit-access or lifecycle update
                        {rotaLifecycleUnread !== 1 ? "s" : ""} — a request was decided, or an
                        automatic generate/submit/publish step ran.
                      </p>
                      <p className="text-xs text-muted-foreground">
