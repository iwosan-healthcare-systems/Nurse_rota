...
export const Route = createFileRoute("/_app/system-settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "GPS fence, password security, and other system-wide settings.",
      },
    ],
  }),
...
// The landing spot for every future system-wide setting — GPS and Password
// Security moved here from Menu Access (they never belonged there, that
// page was just the nearest existing admin page when they were first added).
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="GPS fence, password security, and other system-wide settings"
      />
