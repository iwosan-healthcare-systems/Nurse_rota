...
// Deliberately NOT named shift.history.tsx — TanStack Router's flat-file convention
// treats a dot as a path separator, which would register this as a CHILD route of
// /shift (getParentRoute: () => AppShiftRoute in the generated tree). shift.tsx's
// ShiftPage has no <Outlet /> (it was never built as a layout), so a child route
// would match the URL but have nowhere to render — exactly the bug this file name
// avoids by staying a hyphenated, independent top-level route instead.
