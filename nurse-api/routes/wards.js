...
router.post('/', wrap(async (req, res) => {
  ...
  const { rows } = await pool.query(
    ...
    [name, facility || null, ratio || null,
      min_morning_nurses || 0, min_morning_supervisor || 0, min_morning_na || 0,
      min_night_nurses || 0, min_night_supervisor || 0, min_night_na || 0,
      patients || 0, staffed || 0]
  );
